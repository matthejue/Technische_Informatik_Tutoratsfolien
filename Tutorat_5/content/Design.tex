...
\newcommand{\titlesecond}{Tutorat 4}
\newcommand{\subtitlesecond}{Nachkommastellen beim den Darstellungen von Festkommazahlen, RETI, CMOS, p-Kanal und n-Kanal Transistoren}
\newcommand{\group}{
\if\juergen1{
    Gruppe 9
}\fi 
