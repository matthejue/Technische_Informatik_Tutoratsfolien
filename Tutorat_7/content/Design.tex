...
\newcommand{\titlesecond}{Tutorat 7}
\newcommand{\subtitlesecond}{Implikanten und Primimplikanten, ON-Menge und Literale, Quine-McCluskey-Algorithmus, Hypercubes und Kosten eines Polynoms}
\newcommand{\group}{
\if\juergen1{
    Gruppe 9
}\fi 
