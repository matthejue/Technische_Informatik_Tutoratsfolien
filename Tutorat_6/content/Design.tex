...
\newcommand{\titlesecond}{Tutorat 6}
\newcommand{\subtitlesecond}{Eindeutigkeit des Kommplements, Boolesche Algebra, Formale Beschreibung von Schaltkreisen, Programmable Logic Arrays}
\newcommand{\group}{
\if\juergen1{
    Gruppe 9
}\fi 
